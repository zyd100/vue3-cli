<template>
  <div class="element-container">
    ...
    <Descrition :showDesc="false" title="按钮" />
    <el-row>
      <el-row>
    ...
    <Descrition :showDesc="false" title="单选" />
    <el-row class="row">
    ...
    <Descrition :showDesc="false" title="多选" />
    ...
    <Descrition :showDesc="false" title="日期选择器" />
    ...
    <Descrition :showDesc="false" title="日期时间选择器" />
